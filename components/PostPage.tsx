  ...
  return (
    <>
      <NextSeo
        ...
        canonical={`https://www.matheusmazeto.com/posts/${meta.slug}`}
        openGraph={{ url: `https://www.matheusmazeto.com/posts/${meta.slug}` }}
        additionalMetaTags={[
      ...
      <article className="max-w-[85ch] mx-auto pt-12 pb-28  px-5">
        <div>
          ...
          <div className="flex flex-col	pt-4 pb-8 text-sm font-thin uppercase text-stone-500 dark:text-stone-400">
